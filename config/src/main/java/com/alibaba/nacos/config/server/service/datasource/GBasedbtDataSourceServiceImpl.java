 ...
 * @author Nacos
 */
public class GBasedbtDataSourceServiceImpl implements DataSourceService {

    private static final Logger LOGGER = LoggerFactory.getLogger(GBasedbtDataSourceServiceImpl.class);

    private static final String JDBC_DRIVER_NAME = "com.gbasedbt.jdbc.IfxDriver";
    ...
    public synchronized void reload() throws IOException {
        try {
            dataSourceList = new GBasedbtDataSourceProperties()
